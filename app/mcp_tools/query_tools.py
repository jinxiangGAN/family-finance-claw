...
TOOLS = [
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "Query spending for flexible periods like yesterday, this week, last week, last month, recent N days, or a custom date range.",
            "parameters": {
                "type": "object",
                "properties": {
                    "scope": {"type": "string", "description": "Query scope", "enum": ["me", "spouse", "family"]},
                    "mode": {"type": "string", "description": "Whether to return a total, item list, or category summary", "enum": ["total", "items", "summary"]},
                    "period": {
                        "type": "string",
                        "description": "Named period. Use custom with start_date/end_date for explicit dates.",
                        "enum": [
                            "today",
                            "yesterday",
                    ...
                    "days": {"type": "integer", "description": "Number of trailing days when period is recent_days"},
                    "start_date": {"type": "string", "description": "Custom start date in YYYY-MM-DD format"},
                    "end_date": {"type": "string", "description": "Custom end date in YYYY-MM-DD format"},
                    "category": {"type": "string", "description": "Optional category filter", "enum": ["", *CATEGORIES]},
                    "limit": {"type": "integer", "description": "Max item count when mode is items, default 20"},
                    "include_special": {"type": "boolean", "description": "Whether to include special/event expenses. Default false."},
                },
                "required": ["scope", "mode"],
            },
